                ...
                <div class="col-6 align-self-center">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input v-model="username" type="text" class="form-control" id="username" autocomplete="off"/>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input v-model="phoneNumber" type="integer" class="form-control" id="phoneNumber" autocomplete="off"/>
                        </div>
                        <div class="mb-3">
                            <label for="address" class="form-label">Address</label>
                            <input v-model="address" type="text" class="form-control" id="address" autocomplete="off"/>
                        </div>
